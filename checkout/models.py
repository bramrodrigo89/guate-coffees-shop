...
class Order(models.Model):
    ...
    def update_total(self):
        """
        Update grand total each time a line item is added, check for delivery costs if needed
        """
...
class OrderLineItem(models.Model):
    ...
    def __str__(self):
        return f'Product ID # {self.product.pk} on order {self.order.order_number}'