...
ALLOWED_HOSTS = ['guatemalan-coffees-shop.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'guate_coffee_shop.urls'
...
if 'HEROKU_POSTGRESQL_PUCE_URL' in os.environ:
    DATABASES = {
        'default': dj_database_url.parse(os.environ.get('HEROKU_POSTGRESQL_PUCE_URL'))
    }
else:
    DATABASES = {
        'default': {
